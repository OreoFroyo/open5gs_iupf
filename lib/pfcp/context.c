...
int ogs_pfcp_context_parse_config(const char *local, const char *remote) // for smf's own pfcp address
{
    int rv;
                ...
                if (!strcmp(remote_key, "pfcp")) {
                    ...
                    do {
                        ...
                        if (num_of_nr_cell_id != 0)
                            ...
                            YAML_SEQUENCE_NODE);
                } else if (!strcmp(remote_key, "ipfcp")){
                    ogs_yaml_iter_t pfcp_array, pfcp_iter;
                    ogs_yaml_iter_recurse(&remote_iter, &pfcp_array);
                    do {
                        ogs_pfcp_node_t *node = NULL;
                        ...
                        ogs_info("beigin for ipfcp address print.");
                        // char ipstr[65 + 1];
